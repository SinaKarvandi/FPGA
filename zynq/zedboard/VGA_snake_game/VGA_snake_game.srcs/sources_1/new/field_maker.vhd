            ...
            if i_reset_n = '0' then
                ...
                case state is 
                    ...
                    when INITIALIZE_UP_EDGE =>
                     ...
                     when INITIALIZE_SNAKE =>
                        -- perform the initialization of right edge of monitor
                        o_change_color <= x"f0f";
                        ...
                        o_change_graphic_column <= std_logic_vector(to_unsigned(((g_height/g_square_size)/2) - (g_snake_len/2) + snake_length_counter, 32));
                        o_change_graphic_row <= std_logic_vector(to_unsigned((g_width/g_square_size)/2, 32) - 1);
