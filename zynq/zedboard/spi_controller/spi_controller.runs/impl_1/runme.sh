...
HD_PWD='C:/Users/sina/Documents/HDL/spi_controller/spi_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_Control.tcl -notrace
